...
$$
P(A) = \frac{\text{number}\, \text{of}\, \text{favorable}\, \text{sample}\, \text{points}\, \text{in}\, \text{A}} {\text{ total}\,\text{ number}\,\text{ of}\,\text{ samples}\,\text{ in }\,\Omega }=\frac{\text{the}\,\text{ number }\,\text{of}\,\text{ basic}\,\text{ events}\,\text{ in }\,\text{A}}{\text{number}\,\text{ of}\,\text{ basic}\,\text{ events}}
$$
